...
export default function Search() {
  ...
  const dummyResults = [
    { id: 1, region: '도봉구', keyword: '시설', title: '공문 제목 공문 제목 공문 제목', date: '2025.07.30' },
    { id: 2, region: '강북구', keyword: '문화', title: '새로운 문화 행사 안내', date: '2025.07.29' },
    { id: 4, region: '도봉구', keyword: '교통', title: '버스 노선 변경 공지', date: '2025.07.28' },
    { id: 5, region: '도봉구', keyword: '교통', title: '버스 노선 변경 공지', date: '2025.07.28' },
    { id: 6, region: '도봉구', keyword: '교통', title: '버스 노선 변경 공지', date: '2025.07.28' },
    { id: 7, region: '도봉구', keyword: '교통', title: '버스 노선 변경 공지', date: '2025.07.28' },
    { id: 8, region: '도봉구', keyword: '교통', title: '버스 노선 변경 공지', date: '2025.07.28' },
    { id: 9, region: '도봉구', keyword: '교통', title: '버스 노선 변경 공지', date: '2025.07.28' },
  ];
